...
const DICTS: Record<Locale, Dict> = {
  en: {
    ...
    conversionUnits: "Conversion to smaller units",
    conversionUnitsDesc: "Use units",
    sats: "sats",
  ...
  ru: {
    ...
    conversionUnits: "Конвертация в меньшие единицы",
    conversionUnitsDesc: "Используйте единицы",
    sats: "сатоши",
