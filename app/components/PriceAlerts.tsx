...
const PriceAlerts = memo(function PriceAlerts({
  currentPrice,
  currency,
  onAlertTriggered,
}: PriceAlertsProps) {
    ...
    <>
                    ...
                    >
                      <div className='flex-1 min-w-0'>
                        <p className='text-sm font-medium text-slate-900 dark:text-white truncate'>
                          {alert.isAbove ? t("above") : t("below")}{" "}
                          {alert.targetPrice.toLocaleString()} {alert.currency}
                        </p>
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <div className='flex items-center space-x-2'>
                  <button
                    onClick={() =>
                      setNewAlert((prev) => ({ ...prev, isAbove: true }))
                    }
                  ...
                  <button
                    onClick={() =>
                      setNewAlert((prev) => ({ ...prev, isAbove: false }))
                    }
                    className={`flex-1 px-3 sm:px-4 py-2 rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 ${
                      !newAlert.isAbove
                        ? "bg-amber-700 text-white shadow-lg"
      ...
      {notification && (
        <div className='fixed top-4 right-4 z-50'>
          <div
            className={`flex items-center space-x-3 px-4 py-3 rounded-xl shadow-lg backdrop-blur-sm ${
