...
const KNOWN_FIATS: Record<
  string,
  { symbol: string; names: FiatCurrency["names"] }
> = {
  USD: {
    symbol: "$",
    names: DEFAULT_FIATS.find((f) => f.code === "USD")?.names || {},
  },
  EUR: {
    symbol: "€",
    names: DEFAULT_FIATS.find((f) => f.code === "EUR")?.names || {},
  },
  GBP: {
    symbol: "£",
    names: DEFAULT_FIATS.find((f) => f.code === "GBP")?.names || {},
  },
  CAD: {
    symbol: "C$",
    names: DEFAULT_FIATS.find((f) => f.code === "CAD")?.names || {},
  },
  AUD: {
    symbol: "A$",
    names: DEFAULT_FIATS.find((f) => f.code === "AUD")?.names || {},
  },
  SEK: {
    symbol: "kr",
    names: DEFAULT_FIATS.find((f) => f.code === "SEK")?.names || {},
  },
  CHF: {
    symbol: "Fr",
    names: {
